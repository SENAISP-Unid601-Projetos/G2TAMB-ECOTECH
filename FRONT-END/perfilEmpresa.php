                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                                ...
                                <li> <a href="cadastroColeta.html">Coleta</a></li>
                                <li> <a href="forum.php">Fórum</a></li>							
                                <li> <a href="criarpost.php">Postar</a></li>                                
                                <li> <a href="denuncia.php" >Denunciar</a></li>
                                <li><a href="perfilEmpresa.php" class="active" style="padding: 0%; width: 70px;">Perfil</a></li>
                            </ul>   
    ...
    <div class="profile-container" style="margin-top: 90px;">
        ...
        <div class="profile-header">
            ...
            <div style="display: flex; justify-content: space-between;">
                <div class="profile-info">
                    ...
                    <p class="bio"> <strong>Telefone:</strong> <?php echo $usua["telefone"]; ?></p>
                ...
                <div style="margin-left: 470px; display:flex; justify-content: space-around; width: 190px;">
                    <button class="save" id="editar">Editar</button>
                    <a href="sair.php"><button class="tchau" id="sair">Sair</button></a>
                </div>
            </div>
            <?php
            }
        ...
        <?php
                $sql = "
                        ...
                        WHERE	IDENTIFICACAO = '".$_SESSION['usuario_cnpj']."'
                        ORDER BY ID DESC";
