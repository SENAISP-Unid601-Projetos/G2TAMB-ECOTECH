...
void main() {
  runApp(Home_terceiro());
}

class Home_terceiro extends StatelessWidget {
  @override
  ...
  void _onItemTapped(int index) {
    ...
    switch (index) {
      case 0:
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Perfil_empresa()),
        );
        break;
      case 1:
        Navigator.push(
            ...
            Row(
              ...
              children: [
                TextButton.icon(
                  ...
                  icon: Icon(
                    Icons.thumb_up,
                    color: isLiked ? const Color.fromARGB(255, 253, 0, 0) : const Color.fromARGB(255, 38, 56, 46),
                  ),
                  label: Text(
                    'Curtir',
                    style: TextStyle(
                      color: isLiked ? const Color.fromARGB(255, 255, 1, 1) : const Color.fromARGB(255, 38, 56, 46),
                    ),
                  ),
                ),
                TextButton.icon(
