                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li><a href="#feature-area">Publicações</a></li>
                                ...
                                <li><a href="perfil.php" class="active" style="padding: 0%; width: 105px;">Perfil <img src="img/fotos_usuarios/usuarioteste_sem_fundo.png" alt="imagem_perfil"></a></li>
                            </ul>   
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="padding: 17px"><input class="editar_input" id="id-<?php echo $conta["id"]; ?>"               type="text"     value="<?php echo $conta["id"]; ?>" disable></td>
