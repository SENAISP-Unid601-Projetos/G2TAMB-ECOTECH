...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      home: CadastroLocalColetaempresa(),
      debugShowCheckedModeBanner: false,
    );
  }
}

class CadastroLocalColetaempresa extends StatefulWidget {
  const CadastroLocalColetaempresa({super.key});
...
class _CadastroLocalColetaState extends State<CadastroLocalColetaempresa> {
