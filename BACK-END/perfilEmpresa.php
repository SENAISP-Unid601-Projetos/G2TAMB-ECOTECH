...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                                ...
                                <li><a href="perfil.php" class="active" style="padding: 0%; width: 70px;">Perfil</a></li>
                            </ul>   
    ...
    <div class="profile-container" style="margin-top: 90px;">
        ...
        <div class="profile-header">
            ...
            <?php
                echo "teste: ".$_SESSION["usuario_cnpj"];
                $sql = 'SELECT	NOME,
                                TELEFONE
                        FROM	EMPRESA
                ...
                $sql = 'SELECT  COUNT(*) QTD
                        FROM    POST 
                        WHERE   FK_ID_USUARIO = '.$_SESSION["usuario_cnpj"]; 
            ...
            <div style="display: flex; justify-content: space-between;">
                <div class="profile-info">
                    ...
                    <p class="bio"><?php echo $usua["telefone"]; ?></p>
