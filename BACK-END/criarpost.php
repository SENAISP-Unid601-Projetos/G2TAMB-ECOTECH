...
<body>
                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li> <a href="criarpost.php" class="active">Postar</a></li>
    ...
    <div class="container" style="margin: 100px;">
        ...
        <!-- <main>
            <div class="tweet-box">
                <div class="user-info">
                    <img src="img/usuarioteste.png" alt="Avatar" class="avatar">
                    <textarea placeholder="O que está acontecendo?" id="descricao"></textarea>
                </div>
                <div class="tweet-footer" style="margin-left: 56px; display: flex; justify-content: space-between;">
                    <div>
                    ...
                    <button class="tweet-button" id="postar">Postar</button>
                </div>
                <div id="image-preview" class="image-preview"></div>
            </div> -->

            <form action="criarpost.php" method="POST" enctype="multipart/form-data"> <!-- Adicionando o form -->
                <div class="tweet-box">
                    <div class="user-info">
                        <img src="img/usuarioteste.png" alt="Avatar" class="avatar">
                    ...
                    <div>
                        ...
                        <button class="tweet-button" type="submit" id="postar">Postar</button> <!-- Adicionado type="submit" -->
                    </div>
                    <div id="image-preview" class="image-preview"></div>
                </div>
        ...
        if (isset($_POST['descricao'])){
            if($_SESSION["usuario_id"] != ''){
                try {
                    ...
                    $sql = "INSERT INTO post (  descricao, 
                                                comentario,
                                                curtida,
                                                foto,
                                                fk_id_usuario,
